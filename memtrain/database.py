...
class Database:
    ...
    def __init__(self):
        ...
        # Helper methods ##########################################################
        def memtrain_query(self, columns, tables):
        ...
        def get_all_responses(self):
            return self.memtrain_query('response', 'responses')

        def get_all_response_ids(self):
            return self.memtrain_query('response_id', 'responses')
        ...
        def get_all_cue_response_id_pairs():
            return self.memtrain_query('cue_id, response_id', 'cues_to_responses')
